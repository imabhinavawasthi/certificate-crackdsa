...
const NewHome = () => {
    ...
    return (
        <>
            ...
            <section class="px-2 xl:py-32 bg-white md:py-10 sm:py-10" >
                <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
                    <div class="flex flex-wrap items-center sm:-mx-3">
                        <div class="w-full md:w-1/2 md:px-3">
                            <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                                <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                                    <span class="block xl:inline">crackDSA Certificates: </span>
                                    <span class="block text-indigo-600 xl:inline">Recognizing Your Achievements.</span>
                                </h1>
                                <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">Hi, {curruser?.name}. Welcome to crackDSA bootcamp certification program! We are excited to offer our students the opportunity to earn a certificate upon completion of our intensive bootcamps.</p>
                                <div class="relative flex flex-col sm:flex-row sm:space-x-4">
                                    ...
                                    <a href="https://events.crackdsa.com/" target="_blank" class="flex items-center px-6 py-3 text-gray-500 bg-gray-100 rounded-md hover:bg-gray-200 hover:text-gray-600">
                                        Explore Events
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="flex flex-wrap items-center -mx-3">
                        <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                            <div class="w-full lg:max-w-md">
                                <h2 class="mb-4 text-3xl font-bold leading-tight tracking-tight sm:text-4xl font-heading text-black">Jam-packed with all the tools you need to succeed!</h2>
