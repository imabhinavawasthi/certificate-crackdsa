...
import samplecerti from "../../assests/samplecerti.png"
    ...
    <div>
      <div class="wrapper">
        ...
        <div class="icons">
          ...
          <a target="_blank" href="https://wa.me/message/TPN76XLWVOWDB1"><i><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
          ...
          <a target="_blank" href="https://events.crackdsa.com/"><i><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-file-code-fill" viewBox="0 0 16 16">
        ...
        <img style={{width:"80%",height:"80%"}} src={samplecerti}>
